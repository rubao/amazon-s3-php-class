 ...
 */
class S3_Amazon extends CFRuntime
{
	/*%******************************************************************************************%*/
	// CLASS CONSTANTS
	...
	/**
	 * Constructs a new instance of <S3_Amazon>. If the <code>AWS_DEFAULT_CACHE_CONFIG</code> configuration
	 ...
	 * @link http://docs.amazonwebservices.com/S3_Amazon/latest/dev/S3_Authentication.html REST authentication
	 */
	public function authenticate($bucket, $opt = null, $location = null, $redirects = 0, $nothing = null)
	{
		...
		*/
		...
		// @see: http://docs.amazonwebservices.com/S3_Amazon/latest/dev/Redirects.html
		// @codeCoverageIgnoreStart
	 ...
	 * <enable_path_style()>.
	 *
	 * @param string $region (Required) The region to use for subsequent Amazon S3 operations. [Allowed values: `S3_Amazon::REGION_US_E1 `, `S3_Amazon::REGION_US_W1`, `S3_Amazon::REGION_EU_W1`, `S3_Amazon::REGION_APAC_SE1`, `S3_Amazon::REGION_APAC_NE1`]
	 ...
	 * @return $this A reference to the current instance.
	 * @link http://docs.amazonwebservices.com/S3_Amazon/latest/dev/VirtualHosting.html Virtual Hosting of Buckets
	 */
	 ...
	 * @param string $region (Required) The preferred geographical location for the bucket. [Allowed values: `S3_Amazon::REGION_US_E1 `, `S3_Amazon::REGION_US_W1`, `S3_Amazon::REGION_EU_W1`, `S3_Amazon::REGION_APAC_SE1`, `S3_Amazon::REGION_APAC_NE1`]
	 * @param string $acl (Optional) The ACL settings for the specified bucket. [Allowed values: <code>S3_Amazon::ACL_PRIVATE</code>, <code>S3_Amazon::ACL_PUBLIC</code>, <code>S3_Amazon::ACL_OPEN</code>, <code>S3_Amazon::ACL_AUTH_READ</code>, <code>S3_Amazon::ACL_OWNER_READ</code>, <code>S3_Amazon::ACL_OWNER_FULL_CONTROL</code>]. The default value is <ACL_PRIVATE>.
	...
	* @return CFResponse A <CFResponse> object containing a parsed HTTP response.
	* @link http://docs.amazonwebservices.com/S3_Amazon/latest/dev/UsingBucket.html Working with Amazon S3 Buckets
	*/
	 ...
	 * 	<li><code>returnCurlHandle</code> - <code>boolean</code> - Optional - A private toggle specifying that the cURL handle be returned rather than actually completing the request. This toggle is useful for manually managed batch requests.</li></ul>
	 * @return CFResponse A <CFResponse> object containing a parsed HTTP response.
	 * @link http://docs.amazonwebservices.com/S3_Amazon/latest/dev/RESTAccessPolicy.html REST Access Control Policy
	 */
	 ...
	 *
	 * @param string $bucket (Required) The name of the bucket to use.
	 * @param string $acl (Optional) The ACL settings for the specified bucket. [Allowed values: <code>S3_Amazon::ACL_PRIVATE</code>, <code>S3_Amazon::ACL_PUBLIC</code>, <code>S3_Amazon::ACL_OPEN</code>, <code>S3_Amazon::ACL_AUTH_READ</code>, <code>S3_Amazon::ACL_OWNER_READ</code>, <code>S3_Amazon::ACL_OWNER_FULL_CONTROL</code>]. Alternatively, an array of associative arrays. Each associative array contains an `id` and a `permission` key. The default value is <ACL_PRIVATE>.
	 * @param array $opt (Optional) An associative array of parameters that can have the following keys: <ul>
	 * 	<li><code>curlopts</code> - <code>array</code> - Optional - A set of values to pass directly into <code>curl_setopt()</code>, where the key is a pre-defined <code>CURLOPT_*</code> constant.</li>
	 * 	<li><code>returnCurlHandle</code> - <code>boolean</code> - Optional - A private toggle specifying that the cURL handle be returned rather than actually completing the request. This toggle is useful for manually managed batch requests.</li></ul>
	 * @return CFResponse A <CFResponse> object containing a parsed HTTP response.
	...
	* 	<li><code>acl</code> - <code>string</code> - Optional - The ACL settings for the specified object. [Allowed values: <code>S3_Amazon::ACL_PRIVATE</code>, <code>S3_Amazon::ACL_PUBLIC</code>, <code>S3_Amazon::ACL_OPEN</code>, <code>S3_Amazon::ACL_AUTH_READ</code>, <code>S3_Amazon::ACL_OWNER_READ</code>, <code>S3_Amazon::ACL_OWNER_FULL_CONTROL</code>]. The default value is <code>ACL_PRIVATE</code>.</li>
	...
	* 	<li><code>storage</code> - <code>string</code> - Optional - Whether to use Standard or Reduced Redundancy storage. [Allowed values: <code>S3_Amazon::STORAGE_STANDARD</code>, <code>S3_Amazon::STORAGE_REDUCED</code>]. The default value is <code>STORAGE_STANDARD</code>.</li>
	* 	<li><code>curlopts</code> - <code>array</code> - Optional - A set of values to pass directly into <code>curl_setopt()</code>, where the key is a pre-defined <code>CURLOPT_*</code> constant.</li>
	* 	<li><code>returnCurlHandle</code> - <code>boolean</code> - Optional - A private toggle specifying that the cURL handle be returned rather than actually completing the request. This toggle is useful for manually managed batch requests.</li></ul>
	* @return CFResponse A <CFResponse> object containing a parsed HTTP response.
	* @link http://docs.amazonwebservices.com/S3_Amazon/latest/dev/RESTAccessPolicy.html REST Access Control Policy
	*/
	 ...
	 * @param array $opt (Optional) An associative array of parameters that can have the following keys: <ul>
	 * 	<li><code>acl</code> - <code>string</code> - Optional - The ACL settings for the specified object. [Allowed values: <code>S3_Amazon::ACL_PRIVATE</code>, <code>S3_Amazon::ACL_PUBLIC</code>, <code>S3_Amazon::ACL_OPEN</code>, <code>S3_Amazon::ACL_AUTH_READ</code>, <code>S3_Amazon::ACL_OWNER_READ</code>, <code>S3_Amazon::ACL_OWNER_FULL_CONTROL</code>]. Alternatively, an array of associative arrays. Each associative array contains an <code>id</code> and a <code>permission</code> key. The default value is <code>ACL_PRIVATE</code>.</li>
	 * 	<li><code>storage</code> - <code>string</code> - Optional - Whether to use Standard or Reduced Redundancy storage. [Allowed values: <code>S3_Amazon::STORAGE_STANDARD</code>, <code>S3_Amazon::STORAGE_REDUCED</code>]. The default value is <code>STORAGE_STANDARD</code>.</li>
	 ...
	 * 	<li><code>returnCurlHandle</code> - <code>boolean</code> - Optional - A private toggle specifying that the cURL handle be returned rather than actually completing the request. This toggle is useful for manually managed batch requests.</li></ul>
	 * @return CFResponse A <CFResponse> object containing a parsed HTTP response.
	 * @link http://docs.amazonwebservices.com/S3_Amazon/latest/dev/API/RESTObjectCOPY.html Copying Amazon S3 Objects
	 */
	 ...
	 * @param array $opt (Optional) An associative array of parameters that can have the following keys: <ul>
	 * 	<li><code>acl</code> - <code>string</code> - Optional - The ACL settings for the specified object. [Allowed values: <code>S3_Amazon::ACL_PRIVATE</code>, <code>S3_Amazon::ACL_PUBLIC</code>, <code>S3_Amazon::ACL_OPEN</code>, <code>S3_Amazon::ACL_AUTH_READ</code>, <code>S3_Amazon::ACL_OWNER_READ</code>, <code>S3_Amazon::ACL_OWNER_FULL_CONTROL</code>]. The default value is <ACL_PRIVATE>.</li>
	...
	*/
	 ...
	 * @param string $bucket (Required) The name of the bucket to use.
	 * @param string $filename (Required) The file name for the object.
	 * @param string $acl (Optional) The ACL settings for the specified object. Accepts any of the following constants: [Allowed values: <code>S3_Amazon::ACL_PRIVATE</code>, <code>S3_Amazon::ACL_PUBLIC</code>, <code>S3_Amazon::ACL_OPEN</code>, <code>S3_Amazon::ACL_AUTH_READ</code>, <code>S3_Amazon::ACL_OWNER_READ</code>, <code>S3_Amazon::ACL_OWNER_FULL_CONTROL</code>]. Alternatively, an array of associative arrays. Each associative array contains an <code>id</code> and a <code>permission</code> key. The default value is <code>ACL_PRIVATE</code>.
	 * @param array $opt (Optional) An associative array of parameters that can have the following keys: <ul>
	 * 	<li><code>curlopts</code> - <code>array</code> - Optional - A set of values to pass directly into <code>curl_setopt()</code>, where the key is a pre-defined <code>CURLOPT_*</code> constant.</li>
	 * 	<li><code>returnCurlHandle</code> - <code>boolean</code> - Optional - A private toggle specifying that the cURL handle be returned rather than actually completing the request. This toggle is useful for manually managed batch requests.</li></ul>
	 * @return CFResponse A <CFResponse> object containing a parsed HTTP response.
	 ...
	 * @link http://docs.amazonwebservices.com/S3_Amazon/latest/dev/S3_ACLs.html Access Control Lists
	 */
	 ...
	 * 	<li><code>returnCurlHandle</code> - <code>boolean</code> - Optional - A private toggle specifying that the cURL handle be returned rather than actually completing the request. This toggle is useful for manually managed batch requests.</li></ul>
	* @return CFResponse A <CFResponse> object containing a parsed HTTP response.
	* @link http://docs.amazonwebservices.com/S3_Amazon/latest/dev/ServerLogs.html Server Access Logging
	*/
	 ...
	 * 	<li><code>returnCurlHandle</code> - <code>boolean</code> - Optional - A private toggle specifying that the cURL handle be returned rather than actually completing the request. This toggle is useful for manually managed batch requests.</li></ul>
	 * @return CFResponse A <CFResponse> object containing a parsed HTTP response.
	 * @link http://docs.amazonwebservices.com/S3_Amazon/latest/dev/LoggingAPI.html Server Access Logging Configuration API
	 */
	 ...
	 * @param string $bucket (Required) The name of the bucket to use.
	 * @param string $filename (Required) The file name for the object.
	 * @param string $storage (Required) The storage setting to apply to the object. [Allowed values: <code>S3_Amazon::STORAGE_STANDARD</code>, <code>S3_Amazon::STORAGE_REDUCED</code>]
	 * @param array $opt (Optional) An associative array of parameters that can have the following keys: <ul>
	 * 	<li><code>curlopts</code> - <code>array</code> - Optional - A set of values to pass directly into <code>curl_setopt()</code>, where the key is a pre-defined <code>CURLOPT_*</code> constant.</li>
	 * 	<li><code>returnCurlHandle</code> - <code>boolean</code> - Optional - A private toggle specifying that the cURL handle be returned rather than actually completing the request. This toggle is useful for manually managed batch requests.</li></ul>
	 * @return CFResponse A <CFResponse> object containing a parsed HTTP response.
	...
	* @link http://docs.amazonwebservices.com/S3_Amazon/latest/dev/S3_QSAuth.html Using Query String Authentication
	*/
	 ...
	 * @link http://docs.amazonwebservices.com/S3_Amazon/latest/dev/index.html?S3TorrentRetrieve.html Using BitTorrent to Retrieve Objects Stored in Amazon S3
	 */
	...
	* 	<li><code>returnCurlHandle</code> - <code>boolean</code> - Optional - A private toggle specifying that the cURL handle be returned rather than actually completing the request. This toggle is useful for manually managed batch requests.</li></ul>
	* @return CFResponse A <CFResponse> object containing a parsed HTTP response.
	* @link http://docs.amazonwebservices.com/S3_Amazon/latest/dev/AccessPolicyLanguage.html Appendix: The Access Policy Language
	*/
	...
	* 	<li><code>returnCurlHandle</code> - <code>boolean</code> - Optional - A private toggle specifying that the cURL handle be returned rather than actually completing the request. This toggle is useful for manually managed batch requests.</li></ul>
	* @return CFResponse A <CFResponse> object containing a parsed HTTP response.
	* @link http://docs.amazonwebservices.com/S3_Amazon/latest/dev/NotificationHowTo.html Setting Up Notification of Bucket Events
	*/
	 ...
	 * refer to <a href="http://docs.amazonwebservices.com/S3_Amazon/latest/dev/BucketRestrictions.html">Bucket Restrictions and Limitations.</a>
	 *
